$(document).ready(function () {
	   $('#confirmButton').click( function () {
			$.get('./CompleteOrder', function (data) {
	          ...
	          } else if(data.trim()=="UNEXPECTED_ACCESS"){
				$("#message").append("<div class=\"alert alert-danger alert-dismissible\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button><strong>Attention! </strong>There was an unexpected access.</div>");
	          }
	      })
		})
